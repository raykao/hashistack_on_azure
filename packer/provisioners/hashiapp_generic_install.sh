...
export HASHIAPP_ZIPFILE=$HASHIAPPNAME"_"$HASHIAPP_VERSION"_linux_amd64.zip"
export HASHIAPP_DOWNLOAD_PATH="/tmp"
export HASHIAPP_DOWNLOAD_URL="https://releases.hashicorp.com/$HASHIAPPNAME/$HASHIAPP_VERSION/$HASHIAPP_ZIPFILE"
